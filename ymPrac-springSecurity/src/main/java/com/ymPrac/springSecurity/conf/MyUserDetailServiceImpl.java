package com.ymPrac.springSecurity.conf;

import com.ymPrac.springSecurity.entity.Account;
import com.ymPrac.springSecurity.entity.Resources;
import com.ymPrac.springSecurity.mapper.AccountMapper;
import com.ymPrac.springSecurity.mapper.ResourcesMapper;
import com.ymPrac.springSecurity.util.PropertiesUtils;
...
//		System.err.println("-----------MyUserDetailServiceImpl loadUserByUsername ----------- ");
	...
	private Set<GrantedAuthority> obtionGrantedAuthorities(Account account) {
		...
		for (Resources res : menus) {
			...
			// 关联代码：conf.huaxin.security.MySecurityMetadataSource#loadResourceDefine
